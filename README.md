...
4. จังหวัดที่ค่าครองชีพสูงจะมีอัตราการเกิดต่ำกว่าจังหวัดที่มีค่าครองชีพต่ำ
    ...
    คำตอบ: ไม่พบความสัมพันธ์ที่ชัดเจนระหว่างค่าครองชีพสูงต่ำกับ %เด็กเกิดใหม่ แต่คาดว่าค่าครองชีพที่สูงขึ้นเป็นหนึ่งในสาเหตุ
