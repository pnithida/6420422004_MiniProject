...
โดยที่ Bar graph จะเรียงลำดับจากจังหวัดที่มี %เด็กเกิดใหม่ลดลงมากที่สุดไปน้อยสุด (จากซ้ายไปขวา) แต่แกน Y จะแสดงตัวเลขเป็นจำนวนคน 
...
4. อัตราเด็กไทยเกิดใหม่ลดลง มีผลมาจากค่าใช้จ่ายที่สูงขึ้นหรือไม่ (เลือกพิจารณาเฉพาะ 6 จังหวัด)
...
จากการวิเคราะห์ข้อมูลจำนวนเด็กเกิดใหม่ตั้งแต่ปีพ.ศ. 2536-2564 พบว่าคนไทยมีแนวโน้มมีลูกลดลงราว 45% ซึ่งเห็นได้ชัดในภาคอีสานที่มีจำนวนลดลงมากกว่าภาคอื่นๆ โดยคาดว่าแนวโน้มที่ลดลงนี้มีสาเหตุจากหลายปัจจัย หนึ่งในนั้นคือ หลังวิกฤตการหรืออุบัติภัยต่างๆเกิดขึ้น จะทำให้จำนวนเด็กที่เกิดในปีนั้นๆหรือปีถัดมาลดลงอย่างเห็นได้ชัด ต่อมาคาดว่าการที่รายได้และรายจ่ายมีความใกล้เคียงกันสูง อาจส่งผลกระทบให้คนไทยมีเงินใช้สอยน้อยลง จึงทำให้ยังไม่อยากมีลูก และสุดท้ายจากการสุ่มพิจารณา 6 จังหวัดได้แก่ ชัยนาท อ่างทอง ตรัง หนองคาย แม่ฮ่องสอน และตาก คือการที่ค่าครองชีพสูงขึ้นเป็นหนึ่งในปัจจัย อย่างไรก็ตามไม่สามารถหาความสัมพันธ์ได้ว่าหากจังหวัดนั้นๆมีค่าครองชีพที่สูงขึ้น จะทำให้อัตราเด็กเกิดใหม่จะลดลงหรือไม่ นอกจากนี้พบว่าการที่ GPP/มูลค่าการผลิตสินค้าของแต่ละจังหวัดจะมากหรือน้อย ไม่มีความสัมพันธ์กับอัตราการเด็กเกิดใหม่
